...
import com.example.shixiaorong.loginhomework.MD5Utils;
...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText editPhone = (EditText) findViewById(R.id.EditRegisterPhone);
    ...
    private void init() {
        ...
        et_user_name=findViewById(R.id.EditRegisterPhone);
        ...
        btn_register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(userName)){
                    ...
                    Toast.makeText(RegisterActivity.this, "此手机好号已经存在", Toast.LENGTH_SHORT).show();
                    return;
                }else{
